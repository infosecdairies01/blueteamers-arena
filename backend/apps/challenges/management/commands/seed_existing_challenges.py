        ...
        "questions": [
            {
                ...
                "kind": "text",
                "correct_answer": "Spearphishing Link / Exploit",
                "points": 80,
            },
            {
                "id": "q2",
                "prompt": "What was the attacker dwell time (in hours)?",
                "kind": "text",
                "correct_answer": "72",
                "points": 80,
            },
            {
                ...
                "correct_answer": "Scheduled Task",
                "points": 80,
            },
            {
                "id": "q4",
                "prompt": "What was the primary command-and-control (C2) IP address?",
                "kind": "text",
                "correct_answer": "192.0.2.14",
                "points": 80,
            },
            {
                "id": "q5",
                "prompt": "What data or artifact indicates the attacker's final objective?",
                "kind": "text",
                "correct_answer": "Staged archive financial_db_backup.7z sent to external server",
                "points": 80,
            },
        ],
    },
